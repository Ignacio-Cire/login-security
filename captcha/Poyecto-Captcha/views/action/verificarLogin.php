...
include_once '../utils/datasubmitted.php'; // Incluye el archivo donde tienes definida la función
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $datosUsuario = [
        ...
        'email' => $datos['email'],
        'password' => $datos['password'] ?: null, // Deja en null si la contraseña está vacía
